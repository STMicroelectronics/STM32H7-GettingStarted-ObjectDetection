...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "st_ssd_mobilenet_v1_025_192_int8"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x725b564017a637334c6c5f9249247ffc"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0xf467f4686f9d1a88)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,192,192,3}
...
#define STAI_NETWORK_IN_1_SCALE       (0.007843137718737125f)
#define STAI_NETWORK_IN_1_ZERO_POINT  (127)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_NETWORK_OUT_NUM             (3)
#define STAI_NETWORK_OUT_SIZE_BYTES      (153204)
...
#define STAI_NETWORK_OUT_1_SHAPE       {1,3830,2}
#define STAI_NETWORK_OUT_1_BATCH       (1)
#define STAI_NETWORK_OUT_1_HEIGHT      (3830)
#define STAI_NETWORK_OUT_1_CHANNEL     (2)
#define STAI_NETWORK_OUT_1_RANK        (2)
#define STAI_NETWORK_OUT_1_SIZE        ((3830 * 2))
#define STAI_NETWORK_OUT_1_SIZE_BYTES  (30640)
...
#define STAI_NETWORK_OUT_2_SHAPE       {1,3830,4}
#define STAI_NETWORK_OUT_2_BATCH       (1)
#define STAI_NETWORK_OUT_2_HEIGHT      (3830)
#define STAI_NETWORK_OUT_2_CHANNEL     (4)
#define STAI_NETWORK_OUT_2_RANK        (2)
#define STAI_NETWORK_OUT_2_SIZE        ((3830 * 4))
#define STAI_NETWORK_OUT_2_SIZE_BYTES  (61280)
...
#define STAI_NETWORK_OUT_3_SHAPE       {1,3830,4}
#define STAI_NETWORK_OUT_3_BATCH       (1)
#define STAI_NETWORK_OUT_3_HEIGHT      (3830)
#define STAI_NETWORK_OUT_3_CHANNEL     (4)
#define STAI_NETWORK_OUT_3_RANK        (2)
#define STAI_NETWORK_OUT_3_SIZE        ((3830 * 4))
#define STAI_NETWORK_OUT_3_SIZE_BYTES  (61280)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_NETWORK_ACTIVATIONS_SIZE              (246256)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (246256)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (246256)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (246256)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (494760)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (494760)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (494760)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (494760)
